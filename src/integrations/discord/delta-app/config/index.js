...
export const SAILOR_PERMISSIONS = [
  ROLE_PERMISSIONS.ADD_REACTIONS,
  ROLE_PERMISSIONS.STREAM,
  ROLE_PERMISSIONS.VIEW_CHANNEL,
  ROLE_PERMISSIONS.SEND_MESSAGES,
  ROLE_PERMISSIONS.EMBED_LINKS,
  ROLE_PERMISSIONS.ATTACH_FILES,
  ROLE_PERMISSIONS.READ_MESSAGE_HISTORY,
  ROLE_PERMISSIONS.USE_EXTERNAL_EMOJIS,
  ROLE_PERMISSIONS.CONNECT,
  ROLE_PERMISSIONS.SPEAK,
];
...
export const CAPTAIN_PERMISSIONS = [ROLE_PERMISSIONS.ADMINISTRATOR];
...
export const BREAKOUT_TEMPLATE = async (cohort_id) => {
  ...
  const cohortChannel = await findRole({
    guild_id,
    name: cohortChannelName[0],
  });
...
export const ASSESSMENT_MESSAGE_TEMPLATE = (
  channel,
  phase,
  date,
  currentDay,
...
export const VOICE_URLS = [
  ...
  'https://www.youtube.com/watch?v=q33Ns5uG3yU',
